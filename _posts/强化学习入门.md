...
![](https://latex.codecogs.com/gif.latex?<center>r(s,&space;a,&space;s’)&space;=&space;E[R<sub>t&plus;1</sub>|<sub>t</sub>=s,&space;A<sub>t</sub>=a,&space;S<sub>t&plus;1</sub>=s']</center>&space;r(s,&space;a,&space;s')&space;=&space;E[R_]])  
### 7.价值函数
